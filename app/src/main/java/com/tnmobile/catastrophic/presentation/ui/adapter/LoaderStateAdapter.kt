...
import kotlinx.android.synthetic.main.item_cat_loader.view.*
    ...
    class LoaderViewHolder(view: View, retry: () -> Unit) : RecyclerView.ViewHolder(view) {
        ...
        companion object {
            ...
            fun getInstance(parent: ViewGroup, retry: () -> Unit): LoaderViewHolder {
                ...
                val view = inflater.inflate(R.layout.item_cat_loader, parent, false)
                return LoaderViewHolder(view, retry)
            }
        }

        val motionLayout: MotionLayout = view.mlLoader
